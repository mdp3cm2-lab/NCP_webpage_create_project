...
food_body = <<~HTML
  ...
  <main id="top">
    ...
    <section id="contact" class="contact reveal"><img src="/food-assets/logo.png" alt="いぶり"><h2>炭火の香りを、街角へ。</h2><p>出店情報・イベント出店・フランチャイズについての情報は、順次こちらでお知らせします。</p><a href="mailto:#{h(contact_email(site['food_contact_email']))}?subject=#{CGI.escape('いぶりへのお問い合わせ')}">お問い合わせ</a></section>
  </main>
